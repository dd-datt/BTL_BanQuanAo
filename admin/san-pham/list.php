...
$list_products = $ProductModel->select_list_products($keyword, $cate_id, $page, 5); // Lấy danh sách sản phẩm theo điều kiện tìm kiếm
...
$productsPerPage = 5; // Số sản phẩm mỗi trang
